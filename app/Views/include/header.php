...
s.settings = __htas || {};
s.src = "\/\/stylish-airport.com\/c.DM9K6Fbf2f5UlDSFWNQ\/9IN_Dkc\/2GMED\/MQwQNKSh0M0kNwzyY\/wSM\/zcAC2k";
l.parentNode.insertBefore(s, l);
})({"misc":{"bindTo":[".click_hilltop_click"]}})
</script>
<?php } elseif ($arr == 1) { ?>
<script>
(function(__htas){
var d = document,
    ...
    l = d.scripts[d.scripts.length - 1];
s.settings = __htas || {};
s.src = "\/\/stylish-airport.com\/cYD.9u6rbm2o5\/lZS\/WsQV9uNfDxcD2-MnD\/MdzGNGyr0\/0oNTzNYLw\/MVz_Mn4g";
l.parentNode.insertBefore(s, l);
})({"misc":{"bindTo":[".click_hilltop_click"]}})
</script>
<?php } else { ?>
...
<style type="text/css">
  ...
  li.user-nav, .user-nav-mb { display: none; }
